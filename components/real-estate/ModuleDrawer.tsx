...
export function ModuleDrawer({ moduleId, moduleTitle, isOpen, onClose }: ModuleDrawerProps) {
    const { lat, lon, radius_m, window_days } = useAddressContext();
    ...
    useEffect(() => {
        ...
        const fetchItems = async () => {
            ...
            try {
                ...
                // Fetch from the appropriate module API
        ...
        fetchItems();
    }, [isOpen, lat, lon, radius_m, window_days, moduleId]);
